    ...
    public void addCronJob(String jobName, String jobGroup) {
        try {
            ...
            if (jobDetail != null) {
                ...
                //构建job信息
                jobDetail = JobBuilder.newJob((Class<? extends Job>) CronJob.class).withIdentity(jobName, jobGroup).build();
                //用JopDataMap来传递数据
    ...
    public void addAsyncJob(String jobName, String jobGroup) {
        try {
            ...
            if (jobDetail != null) {
                ...
                jobDetail = JobBuilder.newJob((Class<? extends Job>) AsyncJob.class).withIdentity(jobName, jobGroup).storeDurably().build();
